...
<div id="comments" class="comments-area section">
	<div class="container is-narrow">
		...
		<div class="content">
			<div class="header">
				<h2 class="title is-3"><?php esc_html_e('Comments', 'bluegreen'); ?></h2>
				<p class="subtitle">
		...
		<?php if ( get_comment_pages_count() > 1 && get_option( 'page_comments' ) ) : // Are there comments to navigate through? ?>
			<nav id="comment-nav-above" class="navigation comment-navigation" role="navigation">
				<h2 class="screen-reader-text"><?php esc_html_e( 'Comment navigation', 'bluegreen' ); ?></h2>
				<div class="nav-links level">
					<div class="nav-next"><?php next_comments_link( esc_html__( 'Newer Comments', 'bluegreen' ) ); ?></div>
					<div class="nav-previous"><?php previous_comments_link( esc_html__( 'Older Comments', 'bluegreen' ) ); ?></div>
				</div><!-- .nav-links -->
	...
	<?php
		...
		<div class="content">
			<p class="no-comments"><?php esc_html_e( 'Comments are closed.', 'bluegreen' ); ?></p>
		</div>
		<?php
		endif;
		?>
